...
abstract class AppLocalizations {
  ...
  /// No description provided for @leapMonthShort.
  ///
  /// In vi, this message translates to:
  /// **'Nhuận'**
  String get leapMonthShort;
  ...
  /// No description provided for @lunarReminderTitle.
  ///
  /// In vi, this message translates to:
  /// **'Nhắc lịch âm'**
  String get lunarReminderTitle;

  /// No description provided for @firstDayTomorrowReminder.
  ///
  /// In vi, this message translates to:
  /// **'Ngày mai là mùng 1 âm lịch.'**
  String get firstDayTomorrowReminder;

  /// No description provided for @firstDayTodayReminder.
  ///
  /// In vi, this message translates to:
  /// **'Hôm nay là mùng 1 âm lịch.'**
  String get firstDayTodayReminder;

  /// No description provided for @fullMoonTomorrowReminder.
  ///
  /// In vi, this message translates to:
  /// **'Ngày mai là ngày Rằm (15 âm lịch).'**
  String get fullMoonTomorrowReminder;

  /// No description provided for @fullMoonTodayReminder.
  ///
  /// In vi, this message translates to:
